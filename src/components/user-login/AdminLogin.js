        ...
        <div className="loginforms">
            <BrowserRouter>
                <form className="login-doctor-form" >
                    ...
                    <div className="username">Username <input id="username" type="Text" name="adminUsername" /><br></br> </div>
                    <div className="password">Password <input type="password" name="adminPassword" /></div>
